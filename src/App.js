...
import AppContext, { appReducer, initialAppState } from "./provider";

import geoCoords from "./utils/geoLocation";
import getWeather, { getCityCoords, getCityName } from "./services";
